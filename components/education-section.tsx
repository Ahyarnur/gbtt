...
export function EducationSection() {
  ...
  return (
    <section id="education" className="py-12 md:py-16 lg:py-20 bg-background transition-colors duration-300 texture-lines">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 md:space-y-12">
          {educationData.map((edu, index) => (
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/10 border-glow">
                {/* Header */}
                <div className="flex items-start space-x-4 mb-6">
                  <div className={`p-4 rounded-xl bg-white/10 border border-white/10 group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  <div className="flex-1">
                    ...
                    <h4 className="text-lg text-gray-300 font-mono mb-4">
                      {edu.degree}
                    </h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {edu.achievements.map((achievement, achievementIndex) => (
                      <motion.div
                        ...
                        className="flex items-start space-x-3 p-3 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300"
              ...
              {index < educationData.length - 1 && (
                <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-gradient-to-b from-white/30 to-transparent"></div>
              )}
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="inline-flex items-center space-x-3 p-4 rounded-xl bg-white/5 border border-white/10">
