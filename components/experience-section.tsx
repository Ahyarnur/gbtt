...
export function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-12 md:py-16 lg:py-20 bg-dark-900/50 transition-colors duration-300 texture-lines">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-6 md:left-8 lg:left-1/2 transform lg:-translate-x-1/2 w-0.5 h-full bg-gradient-to-b from-primary-500 via-purple-500 to-pink-500"></div>
                ...
                <div className={`ml-12 md:ml-16 lg:ml-0 w-full lg:w-1/2 ${
                  ...
                  >
                    ...
                    <div className="flex items-start space-x-3 md:space-x-4 mb-4">
                      <div className={`p-2 md:p-3 rounded-lg bg-gradient-to-r ${exp.color}`}>
