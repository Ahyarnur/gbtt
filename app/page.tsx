...
export default function Home() {
  return (
    <main className="min-h-screen bg-dark-50 dark:bg-custom-black transition-colors duration-300">
      <FloatingThemeToggle />
      ...
      {/* Footer */}
      <footer className="bg-dark-50/80 dark:bg-custom-black/80 backdrop-blur-sm transition-colors duration-300 border-t border-primary-400/20">
